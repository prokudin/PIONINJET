      SUBROUTINE PION(X,SCALE,MODE,UPV,DNV,SEA,STR,CHM,BOT,GLU)
C***************************************************************C
C                                                               C
...
C
     ...
     .     .8D0,.85D0,.9D0,.95D0,.975D0,1.D0/
      ...
      INIT=1
      OPEN(UNIT=33,FILE='mrsspi10.dat',STATUS='OLD')
      DO 20 N=1,NX-1
      DO 20 M=1,NQ
...
C
     ...
     .     .8D0,.85D0,.9D0,.95D0,.975D0,1.D0/
      ...
      IF(INIT.NE.0) GOTO 10
      INIT=1
      OPEN(UNIT=33,FILE='mrsspi15.dat',STATUS='OLD')
      DO 20 N=1,NX-1
      DO 20 M=1,NQ
      READ(33,50)F(1,N,M),F(2,N,M),F(3,N,M),F(4,N,M),F(5,N,M),F(7,N,M),
     .          F(6,N,M)
...
C
     ...
     .     .8D0,.85D0,.9D0,.95D0,.975D0,1.D0/
      ...
      IF(INIT.NE.0) GOTO 10
      INIT=1
      OPEN(UNIT=33,FILE='mrsspi20.dat',STATUS='OLD')
      DO 20 N=1,NX-1
      DO 20 M=1,NQ
      READ(33,50)F(1,N,M),F(2,N,M),F(3,N,M),F(4,N,M),F(5,N,M),F(7,N,M),
     .          F(6,N,M)
